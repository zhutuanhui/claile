...
<div class="container-fluid">
 ...
 <div class="span10" id="datacontent">
              ...
              <form action="/admin/oprate/doeditrole" method="post" class="form-horizontal">
                        <fieldset>
                        ...
                        <div class="control-group">
                              ...
                              <div class="controls">
                                    <input name="args[description]" id="areacode" type="text" value="<?php echo $ret->description;?>" needle="needle" msg="请输入对用户组的说明" />
                              </div>
                        </div>
                       <!--  <div id="choicebox" class="control-group">
                        ...
                        <div class="control-group">
                              <div class="controls">
                              <input type="hidden" value="<?php echo $ret->id;?> " name="id">
