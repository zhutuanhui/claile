...
<div class="container-fluid">
            		...
            		<div class="accordion-body{x2;if:$method == 'questions' || $method == 'rowsquestions'} in{x2;endif} collapse" id="accordion-element-212076">
            			<div class="accordion-inner">
            				<ul class="unstyled">
            					...
            					<li><a href="/admin/user/permissionlist">权限列表</a></li>
            				</ul>
            			</div>
            		</div>
            	</div>
 ...
 <div class="span10" id="datacontent">
              ...
              <form action="/admin/oprate/doedituser" method="post" class="form-horizontal">
                        <fieldset>
                        <div class="control-group">
                              <label for="area" class="control-label">用户名：</label>
                              <div class="controls">
                                    <input name="args[name]" id="area" type="text" value="<?php echo $ret->name;?>" needle="needle" msg="请输入用户名称" />
                              </div>
                        </div>
                        <div class="control-group">
                              <label for="areacode" class="control-label">用户密码：</label>
                              <div class="controls">
                                    <input name="args[password]" id="areacode" type="password" value="<?php echo $ret->password;?>" needle="needle" msg="请输入用户密码" />
                              </div>
                        </div>
                         <div class="control-group">
                              <label for="areacode" class="control-label">新密码：</label>
                              <div class="controls">
                                    <input name="args[xpassword]" id="areacode" type="password" value="<?php echo $ret->password;?>" needle="needle" msg="请输入用户密码" />
                              </div>
                        </div>
                        <div id="choicebox" class="control-group">
                              ...
                              <div class="controls">
                                    ...
                                    <?php foreach($rets as $val){?>
                                          <option value="<?php echo $val->id;?>" <?php if($role->role_id==$val->id){ echo 'selected';}?>><?php echo $val->name;?></option>
                                         <?php }?>
                                    </select>
                        ...
                        <div class="control-group">
                              <div class="controls">
                              <input type="hidden" value="<?php echo $ret->id;?>" name="args[userid]">
