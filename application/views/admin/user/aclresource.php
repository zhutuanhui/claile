...
<div class="container-fluid">
      <div class="row-fluid">
            ...
            <div class="span10">
             ...
             <form action="/admin/user/doaclresource" method="post">
 <div class="panel panel-default col-md-10">
      <!-- Default panel contents -->
      <input type="hidden" name="roleid" value="<?php echo $name->id; ?>">
      <div class="panel-heading"><?php echo $name->name;?>权限 <p style="float:right"><button class="btn-info">确定操作</button></p></div>
         <!-- Table -->
      ...
      <tr>
            ...
            <th colspan='2' style='vertical-align: middle;text-align: center;'>资源路径</th>
            
      </tr>
      <?php foreach($ret as $val):?>
            <tr>
                 
                  <td style='vertical-align: middle;'><input type="checkbox" name="id[]" value="<?php echo $val->id;?>" <?php 
                  foreach($resourseid as $item)
                  {
                        if($item->resource_id == $val->id)
                        {
                              echo 'checked';
                        }
                  }
                  ...
                  <td style='vertical-align: middle;text-align: center;'><?php echo $val->rsc_view;?></td>
