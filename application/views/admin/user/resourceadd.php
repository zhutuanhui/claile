...
<div class="container-fluid">
 ...
 <div class="span10" id="datacontent">
              ...
              <form action="/admin/user/opresourceadd" method="post" class="form-horizontal">
                        <fieldset>
                        <div class="control-group">
                              <label for="area" class="control-label">资源名称</label>
                              <div class="controls">
                                    <input name="args[description]" id="area" type="text" value="" needle="needle" msg="请输入用户名称" />
                              </div>
                        </div>
                        <div class="control-group">
                              <label for="areacode" class="control-label">类行</label>
                              <div class="controls">
                                    <input name="args[rsc_class]" id="areacode" type="text" value="" needle="needle" msg="请输入用户密码" />
                              </div>
                        </div> 
                        <div class="control-group">
                              <label for="areacode" class="control-label">类名</label>
                              <div class="controls">
                                    <input name="args[rsc_function]" id="areacode" type="text" value="" needle="needle" msg="请输入类名" />
                              </div>
                        </div> 
                        <div class="control-group">
                              <label for="areacode" class="control-label">方法名</label>
                              <div class="controls">
                                    <input name="args[rsc_action]" id="areacode" type="text" value="" needle="needle" msg="请输入方法名称" />
                              </div>
                        </div>
                        ...
                        <div class="control-group">
                              ...
                              <div class="controls">
                                    <input name="args[rsc_view]" id="areacode" type="text" value="" needle="needle" msg="请输入方法名称" />
                              </div>
                        </div>
                        <div class="control-group">
                              <div class="controls">
