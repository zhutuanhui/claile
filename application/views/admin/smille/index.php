		...
		<div class="span10">
			...
			<div class="row-fluid">
				<div class="span6">
                 ...
                 <form action="/admin/smille/dofa" method="post" enctype="multipart/form-data">
                   <div class="control-group">
                              <div class="controls">
                                    <input name="title" id="area" type="text" style="height:35px;" value="" needle="needle" msg="请输入用户名称"   placeholder="标题在60字内" required/>
                                    <input name="author" id="area" type="text" style="height:35px;" value="" needle="needle" msg="请输入用户名称"   placeholder="请填写作者名字" required/>
            ...
            <div class="form-group">
                      <label for="name">文章介绍</label>
                      <textarea class="form-control" rows="5" name="intro" required>请填写文章介绍</textarea>
                    </div> 
